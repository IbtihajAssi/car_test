...
public class signupTest {
	...
	@When("user with usertype\"{int}\" set email with {string} and username with {string} and password with {string} and confirmpassword with {string}")
	public void userWithUsertypeSetEmailWithAndUsernameWithIbtihajAndPasswordWithAndConfirmpasswordWith(Integer usertype, String email, String name,String pass ,String confpass) {
